...
public:
	...
	NET_SEARCHCALLBACK _NET_SEARCHCALLBACK=nullptr;
	NET_EVENTCALLBACK _NET_EVENTCALLBACK = nullptr;
	NET_CONSTAUSCALLBACK _NET_CONSTAUSCALLBACK = nullptr;
	NET_SMARTRECVCALLBACK _NET_SMARTRECVCALLBACK = nullptr;
	...
	NET_gate_callback _NET_gate_callback = nullptr; // 新增道闸状态改变回调函数 2018.09.25

	NET_PREVIEWDATACALLBACK _NET_PREVIEWDATACALLBACK = nullptr;
	NET_PREVIEWSTAUSCALLBACK _NET_PREVIEWSTAUSCALLBACK = nullptr;
	NET_DECODEDATACALLBACK _NET_DECODEDATACALLBACK = nullptr;
	int m_curID = -1;

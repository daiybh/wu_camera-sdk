...
// lib 
#ifdef _DEBUG
#pragma comment (lib,"../lib/EYESTNETLIB.lib")
#else
#pragma comment (lib,"../lib/EYESTNETLIB.lib")
#endif
class ClassCallBack
{
#define outFunName {printf("\n%s\n",__FUNCTION__);}
public:
	// 报警回调
...
public:
	...
	bool isValidIpaddr()
	{
		if (strlen(m_ipaddrstr) < 7 || strcmp(m_ipaddrstr, "0.0.0.0") == 0)return false;
		return true;
	}
protected:
